...
namespace XamarinTextRecognitionCamera
{
    [Activity(Label = "XamarinTextRecognitionCamera", MainLauncher = true, Icon = "@drawable/icon",Theme ="@style/Theme.AppCompat.Light.NoActionBar")]
